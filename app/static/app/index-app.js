...
var layoutApp = angular.module('firstApplication', ['ngMaterial']);
layoutApp.controller('layoutController', layoutController);
layoutApp.controller('gridController', gridController);
function layoutController($scope, $mdToast, $document) {
    var cookie = $mdToast.simple().textContent("Cookies werden oder können verwendet werden.").action("OK").highlightAction(false)
        .hideDelay(100000000);
    $mdToast.show(cookie);

    function gridController($scope) {
        $scope.grid = [[("Komfort"), ("Gesundheit")], [("Sicherheit"), ("Energie")]];
    }
    ...
    angular
        ...
        .controller('gridListController', function ($scope) {
        })
